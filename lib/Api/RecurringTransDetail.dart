class RecurringTransDetial {
  ...
  RecurringTransDetial.fromJson(Map<String, dynamic> json) {
...
class Linked {
  ...
  Linked({this.name, this.timestamp, this.amountTransaction, this.message});
