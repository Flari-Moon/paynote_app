...
Payload _$PayloadFromJson(Map<String, dynamic> json) {
  return Payload(
    ...
    tRANSFERACCOUNTEXTERNAL: json['tRANSFERACCOUNTEXTERNAL'] as String,
    mESSAGE: json['mESSAGE'] as String,
    tRANSFERACCOUNTNAMEEXTERNAL: json['tRANSFERACCOUNTNAMEEXTERNAL'] as String,
  );
}

Map<String, dynamic> _$PayloadToJson(Payload instance) => <String, dynamic>{
      'dETAILS': instance.dETAILS,
      'tRANSFERACCOUNTEXTERNAL': instance.tRANSFERACCOUNTEXTERNAL,
      'mESSAGE': instance.mESSAGE,
      'tRANSFERACCOUNTNAMEEXTERNAL': instance.tRANSFERACCOUNTNAMEEXTERNAL,
    };
