...
class EditProfileOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<EditProfileModel>.reactive(
      ...
      onModelReady: (model) => {model.initUser(), model.initLanguage()},
    );
  }
        ...
        children: [
          Row(
            children: [
              Text(
                  //"Profile",
                  model.pageLanguageData["PRO-1-01"][0]
          ...
          Container(
            ...
            child: Text(
              //"Edit your profile",
              model.pageLanguageData["PRO-1-00"][0]
                  [model.userLanguage.language],
              style: TextStyle(
                  ...
                  child: FlatButton(
                    ...
                    child: Center(
                      child: model.image_file == null
                          ? Text(
                              //"add photo",
                              model.pageLanguageData["PRO-1-10"][0]
                                  [model.userLanguage.language],
                    ...
                    children: [
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            //labelText: "Name",
                            labelText: model.pageLanguageData["PRO-1-11"][0]
                                [model.userLanguage.language],
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            //labelText: "Surname",
                            labelText: model.pageLanguageData["PRO-1-21"][0]
                                [model.userLanguage.language],
                            contentPadding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                          ),
                        ),
                      ...
                      /*Container(
                        ...
                        child:DateTimeField(
                          ...
                          onChanged: (currentValue) {
                            ...
                            model.inputBirth = currentValue.toString();
                          },
            ...
            Container(
                child: model.verificationEmail == false
                    ...
                    : Text(
                        ...
                        model.pageLanguageData["PRO-1-70"][0]
                            [model.userLanguage.language],
              ...
              child: RaisedButton(
                  ...
                  child: Container(
                    ...
                    child: Center(
                        child: Text(
                      //"Save Changes",
                      model.pageLanguageData["PRO-1-60"][0]
                          [model.userLanguage.language],
                      style: TextStyle(
                ...
                : RaisedButton(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        ...
                        model.pageLanguageData["PRO-1-90"][0]
                            [model.userLanguage.language],
                        style: TextStyle(
                            color: AppColors.brandBlue,
                            fontFamily: 'Alata',
