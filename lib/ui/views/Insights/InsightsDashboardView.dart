...
import 'InsightsDashoboardViewModel.dart';

class InsightDashboardView extends StatelessWidget {
  final User user;

  NavigationService _navigationService = locator<NavigationService>();

  InsightDashboardView({@required this.user});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<InsightDashboardViewModel>.reactive(
      ...
      viewModelBuilder: () => InsightDashboardViewModel(),
      onModelReady: (model) => {model.imageCreate(user.picture, user, context)},
    );
  }
  ...
  Widget _bottomAppBar(BuildContext context, InsightDashboardViewModel model) {
